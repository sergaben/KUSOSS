...
/**
  ...
  *
  */
class GetSubjectsTest(cc:ControllerComponents, subjectRepositoryImpl: SubjectRepositoryImpl) extends PlaySpec with GuiceOneAppPerSuite with Results {
  ...
  "GetSubjectsTest" should {
    "getSubjectsNamesAsJson" in {
      ...
      val controller = new GetSubjects(Helpers.stubControllerComponents(),subjectRepositoryImpl:SubjectRepositoryImpl)
